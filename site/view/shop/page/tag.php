<div class="breadcrumb-wrap">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li>Tìm kiếm <?php echo $_GET['q']?></li>
        </ul>
    </div>
</div>
<div class="container">
        ...
        <div class="category">
                            ...
                            <div class="panel-group">
                                ...
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-collapse">
                                        <div class="list-group">
                                            ...
                                            <div class="list-group-item">
                                                <a href="javascript:void(0);">Durex</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-collapse">
                                        <div class="list-group">
                                            <div class="list-group-item">
                                                <a href="javascript:void(0);">Caganu Group</a>
                                            </div>
                                            <div class="list-group-item">
                                                <a href="javascript:void(0);">IT Chính Hãng</a>
                                            </div>
                                            <div class="list-group-item">
                                                <a href="javascript:void(0);">bao da điện thoại</a>
                                            </div>
                                            <div class="list-group-item">
                                                <a href="javascript:void(0);">câu cá</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="box-right">
                <div class="group">
                    <div class="group-body">
                        <div class="heading">
                            <span class="title">Kết quả tìm kiếm cho từ khoá "<?php echo $_GET['q'];?>"</span>
