					...
					<nav class="stardust-tabs-header-wrapper" style="top: 44px;">
						<ul class="stardust-tabs-header stardust-tabs-header--light">
							<li class="stardust-tabs-header__tab stardust-tabs-header__tab--active">
								<div class="search-items-tabs-header search-items-tabs-header--popular">
									Liên quan
							...
							<li class="stardust-tabs-header__tab">
								<div class="search-items-tabs-header">
									Giá
									<div class="search-items-tabs-header__triangles">
					...
					<div class="stardust-tabs-panels">
						<section class="stardust-tabs-panels__panel">
							<div class="search-items-container__tab-panel">
								<div class="search-items-container__filter-bar-wrapper" style="top: 88px; transform: translateY(-2.66454e-15px);">
									...
									<div class="categories-filter-bar typo-l14">
										<div class="stardust-horizontal-scroll-view hide-scrollbar">
											<div class="categories-filter-bar__category" style="background: rgb(134, 175, 215);">Sức Khỏe &amp; Sắc Đẹp</div>
											<div class="categories-filter-bar__category" style="background: rgb(118, 201, 189);">Nhà Cửa &amp; Đời Sống</div>
											<div class="categories-filter-bar__category" style="background: rgb(136, 207, 129);">Thời Trang Trẻ Em</div>
											<div class="categories-filter-bar__category" style="background: rgb(134, 175, 215);">Phụ Kiện Thời Trang</div>
											<div class="categories-filter-bar__category" style="background: rgb(118, 201, 189);">Điện Thoại &amp; Phụ Kiện</div>
											<div class="categories-filter-bar__category" style="background: rgb(136, 207, 129);">Đầm</div>
											<div class="categories-filter-bar__category" style="background: rgb(134, 175, 215);">Thời Trang Nam</div>
											<div class="categories-filter-bar__category" style="background: rgb(118, 201, 189);">Giày Dép Nữ</div>
											<div class="categories-filter-bar__category" style="background: rgb(136, 207, 129);">Túi Ví</div>
											<div class="categories-filter-bar__category" style="background: rgb(134, 175, 215);">Mẹ &amp; Bé</div>
											<div class="categories-filter-bar__category" style="background: rgb(118, 201, 189);">Đồ Chơi</div>
										</div>
									</div>
								</div>
								<div class="item-card-list">
									<div class="item-card-list__item-card-wrapper">
										<a class="item-card hairline-border" href="/Phần-mềm-viruts-Kaspersky-Anti-Virus-i.63253678.1398052241">
											<div>
												<div class="item-card__cover-image-wrapper">
													<div class="animated-lazy-image item-card__cover-image"><img class="item-card__cover-image animated-lazy-image__image--ready" src="https://cf.shopee.vn/file/f85293ce58a1695046ef642baa123cf4_tn" style="object-fit: contain;"></div>
												</div>
												<div class="item-card__info">
													<div class="item-card__name typo-l14 item-card__name--two-lines">Phần mềm viruts Kaspersky Anti-Virus</div>
													<div class="item-card__price-shipping">
														<div class="item-card__price-before-discount typo-l12">₫250.000</div>
														<div class="item-card__spacer-price"></div>
														<div class="item-card__actual-price typo-m12">₫170.000</div>
