                     ...
                     <div class="search-items-container__filter-bar-wrapper" style="top: 88px; transform: translateY(-2.66454e-15px);">
                        ...
                        <div class="categories-filter-bar typo-l14">
                           <div class="stardust-horizontal-scroll-view hide-scrollbar">
                              <div class="categories-filter-bar__category" style="background: rgb(134, 175, 215);">Máy câu đứng</div>
                              <div class="categories-filter-bar__category" style="background: rgb(118, 201, 189);">Máy câu ngang</div>
                              <div class="categories-filter-bar__category" style="background: rgb(136, 207, 129);">Cần câu</div>
                              <div class="categories-filter-bar__category" style="background: rgb(134, 175, 215);">Cần câu đứng</div>
                              <div class="categories-filter-bar__category" style="background: rgb(118, 201, 189);">Cân câu ngang</div>
                              <div class="categories-filter-bar__category" style="background: rgb(136, 207, 129);">Máy câu shimano</div>
                              <div class="categories-filter-bar__category" style="background: rgb(134, 175, 215);">Cước câu cá</div>
                              <div class="categories-filter-bar__category" style="background: rgb(118, 201, 189);">Cần câu cá</div>
                              <div class="categories-filter-bar__category" style="background: rgb(136, 207, 129);">Cần câu đứng</div>
                              <div class="categories-filter-bar__category" style="background: rgb(134, 175, 215);">Cần câu cá</div>
                              <div class="categories-filter-bar__category" style="background: rgb(118, 201, 189);">Cần câu đứng</div>
                           </div>
                        </div>
                        <div class="item-card-list">
                            <?php foreach($data["result"]["product"] as $index => $valueProduct ){ ?>
                                    <div class="item-card-list__item-card-wrapper">
											<a class="item-card hairline-border" href="<?php print $valueProduct->url_string;  ?>">
												<div>
